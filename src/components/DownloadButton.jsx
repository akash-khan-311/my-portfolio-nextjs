...
const DownloadButton = () => {
  return (
    <a
      href="https://drive.google.com/uc?export=download&id=19edz_JMtvV7JeDYydcJAcyIWgm7WqKbq"
      download={
        "https://drive.google.com/uc?export=download&id=19edz_JMtvV7JeDYydcJAcyIWgm7WqKbq"
      }
      type="button"
