...
const GetInTouch = () => {
  return (
    <>
      <div>
        <h1 className="text-4xl font-bold dark:text-white">Get in Touch</h1>
        <p className="text-sm dark:text-gray-300 text-gray-600 mt-4 leading-relaxed">
          Have some big idea or brand to develop and need help? Then reach out
          we'd love to hear about your project and provide help.
        </p>
        <ul className="mt-12 space-y-8">
          <li className="flex items-center">
            <MdOutlineEmail className="dark:text-white" />
            <a
              href="javascript:void(0)"
              className="dark:text-white text-sm ml-4"
            >
              akashkhanbdinto@gmail.com
            </a>
          </li>
          <li className="flex items-center">
          ...
          <li className="flex items-center">
            <MdOutlineLocationOn className="dark:text-white" />
            <a
              href="javascript:void(0)"
              className="dark:text-white text-sm ml-4"
            >
